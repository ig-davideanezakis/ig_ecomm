...
const SETTING_FIELDS = [
  ...
  { key: "product_tab_come_acquista", label: "Tab prodotto — Come acquista (HTML)", type: "textarea" },
  { key: "product_tab_garanzia", label: "Tab prodotto — Garanzia (HTML)", type: "textarea" },
  { key: "product_tab_recesso", label: "Tab prodotto — Recesso (HTML)", type: "textarea" },
